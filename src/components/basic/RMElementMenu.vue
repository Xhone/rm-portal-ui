<template>
  <div class="rm-el-menu">
    <el-menu
      close="rm-el-menu--vertical"
...
<script>
import RMElementMenuChild from './RMElementMenuChild';
...
export default defineComponent({
  components: {
    'rm-element-menu-child': RMElementMenuChild
  },
  props: {
    enable: {
      type: Boolean,
